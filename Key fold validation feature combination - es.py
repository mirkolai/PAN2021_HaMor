...
feature_types=numpy.array([
             "ngrams", #numpy.mean(accuracy), 0.755 [0.725, 0.775, 0.775, 0.725, 0.775]
             "user_morality_profile", #=numpy.mean(accuracy), 0.755 [0.725, 0.775, 0.775, 0.725, 0.775]
             "hurtlex",#+numpy.mean(accuracy), 0.8 [0.875, 0.7, 0.825, 0.8, 0.8]
             "no_swearing",#=numpy.mean(accuracy), 0.8 [0.875, 0.7, 0.825, 0.8, 0.8]
             "racial_slur",#-numpy.mean(accuracy), 0.79 [0.825, 0.7, 0.8, 0.775, 0.85]
             "emoji_profile",#+numpy.mean(accuracy), 0.8049999999999999 [0.875, 0.7, 0.825, 0.825, 0.8]
             "bio_profile",#-numpy.mean(accuracy), 0.8 [0.85, 0.725, 0.825, 0.8, 0.8]
             "hateeval_prediction",#=numpy.mean(accuracy), 0.8049999999999999 [0.875, 0.7, 0.825, 0.775, 0.85]
             "atalay_sp",#+numpy.mean(accuracy), 0.8099999999999999 [0.85, 0.725, 0.85, 0.8, 0.825]
             "numhashtag",
             "nummention",
             "puntuactionmarks",
             "length",
